...
export const TableActionColumns = {
    Edit: {
        ...
        render: function () {
            return '<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi pointer bi-pencil-fill" fill="#409eff" xmlns="http://www.w3.org/2000/svg">\n' +
    ...
    Delete: {
        ...
        render: function () {
            return '<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi pointer bi-trash" fill="#f56c6c" xmlns="http://www.w3.org/2000/svg">\n' +
    ...
    View: {
        ...
        render: function () {
            return '<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi pointer bi-person-lines-fill" fill="#6c757d" xmlns="http://www.w3.org/2000/svg">\n' +
    ...
    Resend: {
        ...
        render: function () {
            return '<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-envelope-fill" fill="#67c23a" xmlns="http://www.w3.org/2000/svg">\n' +
    ...
    Block: {
        ...
        render: function (data) {
            if (data.deleted_at) {
                return '<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-lock-fill" fill="#909399" xmlns="http://www.w3.org/2000/svg">\n' +
                    '  <path d="M2.5 9a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-7a2 2 0 0 1-2-2V9z"/>\n' +
                    '  <path fill-rule="evenodd" d="M4.5 4a3.5 3.5 0 1 1 7 0v3h-1V4a2.5 2.5 0 0 0-5 0v3h-1V4z"/>\n' +
                    '</svg>';
            }
            return '<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-unlock-fill" fill="#909399" xmlns="http://www.w3.org/2000/svg">\n' +
