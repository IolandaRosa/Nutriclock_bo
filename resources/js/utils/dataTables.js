...
export const TableActionColumns = {
    ...
    View: {
        ...
        render: function (data) {
            return '<span class= "d-flex align-items-center pointer" data-toggle="tooltip" title="Detalhes"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-lines-fill" fill="#6c757d" xmlns="http://www.w3.org/2000/svg">\n' +
