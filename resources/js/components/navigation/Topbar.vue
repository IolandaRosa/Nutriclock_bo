        ...
        <div class="top-bar-container">
            <div style="display: flex">
                <div class="top-bar-items">
                    <button type="button" class="btn btn-outline-primary btn-sm mr-2" v-on:click="logout">Logout</button>
                    <button type="button" class="btn btn-outline-primary btn-sm mr-2" v-on:click="() => {this.$router.push('/configurations')}">
            ...
            <div class="top-bar-info pointer" v-on:click="() => {this.$router.push('/profile')}">
