<template>
    <div>
        <div class="message-sidebar ">
            ...
            <div>
                <div v-if="!data || data.length === 0" class="mt-4 text-dark d-flex flex-column justify-content-center text-center">
                ...
                <div v-else class="card text-white bg-primary mt-2" v-for="(item, index) in data">
                    <div class="card-header d-flex justify-content-end">
                        <button class="btn btn-outline-light mr-1" @click="() => { redirectToMessageHistory(item.senderId) }">
