            ...
            <div class="modal-wrapper">
                <div class="modal-container">
                    ...
                    <div class="modal-footer">
                        <button class="btn-bold btn btn-primary" @click="onSaveClick" id="add-disease-modal-save-btn">
                            Guardar
                        </button>
                        <button class="btn-bold btn btn-secondary" @click="onCloseClick" id="add-disease-modal-close-btn">
                            Cancelar
                        </button>
                    </div>
                </div>
